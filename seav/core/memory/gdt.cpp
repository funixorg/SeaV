...
void gdt_set_gate(int num, uint64_t base, uint32_t limit, uint8_t access, uint8_t granularity) {
...
void gdt_init() {
    ...
    gdt_ptr.base = (uint64_t)&gdt_entries[0];  // Use &gdt_entries[0] to get the address of the first element
